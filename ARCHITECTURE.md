...
- analysis: `is_relevant`, `categories`, `has_wish`, `word_count`
- extras: `metadata`
...
6. optionally write `validation_report.md`
...
- Quote selection favors relevant, wish-heavy, moderately long posts with some engagement; it is heuristic, not model-based
